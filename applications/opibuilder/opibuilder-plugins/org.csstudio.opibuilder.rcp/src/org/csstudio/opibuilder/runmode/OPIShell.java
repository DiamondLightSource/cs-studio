...
public final class OPIShell implements IOPIRuntime {
    ...
    private OPIShell(Display display, IPath path, MacrosInput macrosInput) throws Exception {
         ...
         *
         * Display an overlay warning widget over the current OPI displays to inform the user that a modal
         * dialog is open somewhere in the workspace. Once the dialog is closed, then the OPI shells are
